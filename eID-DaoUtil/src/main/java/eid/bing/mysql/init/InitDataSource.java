...
public class InitDataSource {
    private static ConcurrentHashMap<String, DruidDataSource> sourcePool = new ConcurrentHashMap<String, DruidDataSource>();
    ...
    static {
        InputStream in = InitDataSource.class.getClassLoader().getResourceAsStream("DataConfig.json");
    ...
    synchronized public static DruidDataSource getOneDataSource(String dbName) {
        if (dbName == null) {
            return null;
        }
